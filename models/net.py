...
if __name__ == '__main__':
    # 132.98 MB      32.33 MB       14.83 MB        3.67 MB
    # 34.75 FLOPs(G)  8.79 FLOPs(G)  5.38 FLOPs(G)  0.720107008 FLOPs(G)
    x = torch.randn(1, 3, 300, 300)
    net = build_net(phase='test', size=300, num_classes=2)  # RFBNet网络构建
